...
/*! Constructor
*/
NG3::NG3( std::string name, Instrument symbol,
...
int NG3::preliminaries( const std::deque<Event>& data1,
...
*/
void NG3::compute_entry( const std::deque<Event>& data1,
                                const std::deque<Event>& data1D,
                                const PositionHandler& position_handler,
                                std::array<Event, 2> &signals )
{
    ...
    double POI_short { 0.5*(HighD_[1] + LowD_[1]) };
    // --------------------------------------------------------------------- //
    ...
    Filter1_short = (OpenD_[0]-LowD_[0])> ((OpenD_[1]-LowD_[1]) * 1.5); // 15
    // --------------------------------------------------------------------- //
...
*/
void NG3::compute_exit( const std::deque<Event>& data1,
                               const std::deque<Event>& data1D,
                               const PositionHandler& position_handler,
                               std::array<Event, 2> &signals )
{
...
void NG3::compute_signals( const PriceCollection& price_collection,
                                  const PositionHandler& position_handler,
                                  std::array<Event, 2> &signals )
{
